...
CREATE TABLE "new_Product" (
    ...
    "origin" TEXT NOT NULL DEFAULT 'Inconnu',
    "region" TEXT NOT NULL DEFAULT 'Inconnue',
...
INSERT INTO "new_Product" ("categoriesMilksId", "categoriesPasteCheeseId", "createdAt", "description", "filePath", "id", "imagePath", "isAvailableForPurchase", "name", "priceInCents", "updatedAt", "origin", "region") SELECT "categoriesMilksId", "categoriesPasteCheeseId", "createdAt", "description", "filePath", "id", "imagePath", "isAvailableForPurchase", "name", "priceInCents", "updatedAt", 'Inconnu', 'Inconnue' FROM "Product";
DROP TABLE "Product";
